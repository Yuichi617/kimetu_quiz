...
const persistedReducer = Object(external_redux_persist_["persistReducer"])(persistConfig, counterReducer); //ストア、パーシスターの作成

let store = Object(external_redux_["createStore"])(persistedReducer, info, Object(external_redux_["applyMiddleware"])(external_redux_thunk_default.a));
let pstore = Object(external_redux_persist_["persistStore"])(store); //initStore関数

function initStore(state = info) {
  return Object(external_redux_["createStore"])(counterReducer, state, Object(external_redux_["applyMiddleware"])(external_redux_thunk_default.a));
